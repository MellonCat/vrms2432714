...
import com.champsoft.vrms2432714.modules.agents.application.exception.*;
import com.champsoft.vrms2432714.modules.agents.domain.exception.*;
    ...
    private String toReadableMessage(org.springframework.http.converter.HttpMessageNotReadableException ex) {
        ...
        while (current != null) {
            if (current instanceof com.fasterxml.jackson.databind.exc.InvalidFormatException ife) {
                if (ife.getTargetType() == com.champsoft.vrms2432714.modules.agents.domain.model.Role.class) {
